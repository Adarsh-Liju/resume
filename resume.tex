...
\begin{center}
  ...
  \faLinkedin~\href{https://www.linkedin.com/in/adarsh-liju-abraham}{LinkedIn} \quad
  \faGithub~\href{https://github.com/Adarsh-Liju}{GitHub}
\end{center}
...
\textbf{Programming Languages:} JavaScript, Python, C, C++, PHP, Shell (Bash), MySQL, Golang (Basics)\\
\textbf{Systems:} Linux, SQL, Docker, Kernel Programming\\
\textbf{Computer Fundamentals:} DBMS, Operating Systems, OOPS, Web Development\\
\textbf{Frameworks \& Tools:} Django, ReactJS, Git, AWS, Flask, Pandas, Unix/Linux Tools, OpenMP, MPI, SNMP\\
\textbf{Languages:} Malayalam (Fluent), Hindi (Fluent), English (Fluent), Kannada (Conversational)
